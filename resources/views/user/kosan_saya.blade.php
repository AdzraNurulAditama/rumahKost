...
<div class="w-full md:w-[280px] bg-[#E9F0FF] rounded-[32px] p-4 min-h-[85vh]">
    ...
    <div class="bg-white rounded-[24px] p-6 mb-6 flex flex-col items-center text-center">
        ...
        <h3 class="font-bold text-gray-800 text-sm tracking-tight">{{ Auth::user()->username ?? 'User' }}</h3>
        <p class="text-[10px] text-gray-400 break-all">{{ Auth::user()->email }}</p>
    </div>
...
<div class="flex-1 bg-white rounded-[32px] shadow-sm border border-gray-100 min-h-[85vh] p-10">
    ...
    <h2 class="text-2xl font-black text-gray-800 mb-8">Kosan Saya</h2>
    ...
    <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white border rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition">
            ...
            <div class="p-4">
                <h3 class="font-bold text-gray-800 text-lg mb-1">{{ $sewa->kost->nama }}</h3>
    ...
    <div class="flex flex-col items-center justify-center py-20 text-center">
        <div class="w-20 h-20 bg-blue-50 rounded-full flex items-center justify-center mb-4">
            <i class="fa-solid fa-house text-blue-300 text-3xl"></i>
        </div>
        <h3 class="font-bold text-lg text-gray-700 mb-2">Belum Ada Kosan</h3>
        <p class="text-sm text-gray-400 mb-4">Kamu belum menyewa kosan</p>
        <a href="{{ route('home') }}"
